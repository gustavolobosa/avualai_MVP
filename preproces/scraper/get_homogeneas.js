...
await page.goto('https://www.sii.cl/destacados/reavaluo/2022/4324-4329.html');
...
for (let i = 1; i < regiones.length; i++) {
    ...
    for (let c = comunas.length - 1; c >= (regiones.length); c--) { 
        ...
        if (enlacePDF) {
            ...
            const descargaDir = path.resolve('descargas/homogeneas');
            const fileName = `HOMOGENEA_${texto_region}_${texto_comuna}.pdf`;
